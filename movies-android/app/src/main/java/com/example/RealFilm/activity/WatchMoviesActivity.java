...
//        });
    ...
    private void seekBarVolume(){
        ...
        float MAX_VOLUME = audioManager.getStreamMaxVolume(AudioManager.STREAM_MUSIC);
    ...
    private void setVolume(float MAX_VOLUME){
        float VOLUME = (audioManager.getStreamVolume(AudioManager.STREAM_MUSIC) / MAX_VOLUME) *100;
